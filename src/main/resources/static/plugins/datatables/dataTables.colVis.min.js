  ...
  return d.prototype = {
   ...
   _fnApplyCustomisation: function(b) {
    ...
    var c = this.s.groups,
     e = this.s.aoGroups;
    if (c)
     for (var f = 0, g = c.length; g > f; f++) c[f].title && (e[f].sTitle = c[f].title), c[f].columns && (e[f].aiColumns = c[f].columns)
   },
   _fnDrawCallback: function() {
    ...
    for (var i = function(a) {
      for (var b = 0, c = a.length; c > b; b++)
       if (d[a[b]].bVisible === !1) return !1;
      return !0
     }, j = function(a) {
      for (var b = 0, c = a.length; c > b; b++)
       if (d[a[b]].bVisible === !0) return !1;
      return !0
   ...
   _fnAddGroups: function() {
    ...
    if ("undefined" != typeof this.s.aoGroups)
     for (var b = 0, c = this.s.aoGroups.length; c > b; b++) a = this._fnDomGroupButton(b), this.dom.groupButtons.push(a), this.dom.buttons.push(a), this.dom.collection.appendChild(a)
   },
   _fnAddButtons: function() {
    var b, c = this.s.dt.aoColumns;
    if (-1 === a.inArray("all", this.s.aiExclude))
     for (var d = 0, e = c.length; e > d; d++) - 1 === a.inArray(d, this.s.aiExclude) && (b = this._fnDomColumnButton(d), b.__columnIdx = d, this.dom.buttons.push(b));
   ...
   _fnDataTablesApiIndex: function() {
    for (var a = 0, b = this.s.dt.oInstance.length; b > a; a++)
   ...
   _fnCollectionShow: function() {
    ...
    if (j.height = a(this.dom.button).outerHeight() + "px", j.width = a(this.dom.button).outerWidth() + "px", j.top = e.top + "px", j.left = h + "px", b.body.appendChild(g), b.body.appendChild(f), b.body.appendChild(this.dom.catcher), a(f).animate({
      ...
      opacity: .1
     }, d.s.iOverlayFade, "linear", function() {
